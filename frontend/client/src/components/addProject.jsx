...
const AddProject = (props) => {
    ...
    async function checkExistence() {
        let response = await fetch(`https://${process.env.REACT_APP_API_URL}/admin/getProjectsByName/${projectName}`);
        ...
        if (endDate < startDate) {
            ...
            try {
                ...
                if (projectAlreadyExists) {
                    ...
                    response = await fetch(`https://${process.env.REACT_APP_API_URL}/admin/addProject/${projectName}`, {
                        method: "PATCH",
                        headers: {
                    ...
                    response = await fetch(`https://${process.env.REACT_APP_API_URL}/admin/addProject`, {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                        },
